...
class WaveFunctionCollaps:
    ...
    def run_iteration(self, old_potential):
        ...
        if to_collapse is None:                               #1
            ...
            # np.random.seed(0)
            selected_tile = np.random.choice(nonzero)
...
if __name__ == "__main__":
    images = ['./Images/empty.png,0', './Images/cross.png,0', './Images/line.png,0', './Images/line.png,90']
    ...
    # print(res)
    # WFC.showResult()
    print(len(WFC.process))
    WFC.process[0].save('out.gif', format='gif', save_all=True, append_images=WFC.process[1:],
            duration=50, loop=0)
    WFC.process[-1].save('final.png')
